...
public class SavedImageViewer extends AppCompatActivity {
    ...
    class SomeClass implements View.OnClickListener {
        private final SavedImageViewer imageViewer;
        ...
        SomeClass(SavedImageViewer imageViewer, File file) {
...
//        getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        //tring string = intent.getExtras().getString("pos");
       ...
       /* floatingActionButton2.setOnClickListener(new View.OnClickListener() {
               ...
               /* if (Build.VERSION.SDK_INT >= 24) {
                ...
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "WhatsApp Not Found on this Phone :(", Toast.LENGTH_SHORT).show();
                            ...
                            String strr = imageList.get(viewPager.getCurrentItem()).getPath();
                            shareImage(new File(strr));
        ...
        delete_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SavedImageViewer.this);
                ...
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(SavedImageViewer.this);
                } else {
    ...
    @SuppressLint("WrongConstant")
    public void shareImage(File ff)
    {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            uriForFile = FileProvider.getUriForFile(getApplicationContext(), new StringBuffer().append(getApplicationContext().getPackageName()).append(".provider").toString(), ff);
            try {
                //intent = new Intent("android.intent.action.SEND");
                intent = new Intent();
                ...
                intent.addFlags(EXTRA_DOCK_STATE_DESK);
                //startActivity(intent);


                SavedImageViewer.this.startActivity(Intent.createChooser(intent, "Share Image on: "));
                return;
            } catch (ActivityNotFoundException e) {
