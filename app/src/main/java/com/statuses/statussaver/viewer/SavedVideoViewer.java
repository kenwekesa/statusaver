...
public class SavedVideoViewer extends AppCompatActivity{
    ...
    class SomeClass implements View.OnClickListener {
        private final SavedVideoViewer videoPlayer;
        private final File file;

        class SomeOtherClass implements Runnable {
            private final SavedVideoViewer.SomeClass context;
            private final File file;

            SomeOtherClass(SavedVideoViewer.SomeClass someClass, File file) {
                context = someClass;
                this.file = file;
            }
        ...
        SomeClass(SavedVideoViewer videoPlayer, File file) {
        ...
        public void onClick(View view) {
            new SavedVideoViewer.SomeClass.SomeOtherClass(this, this.file).run();
        }
    }
...
//        getSupportActionBar().setDisplayShowHomeEnabled(true);
       ...
       /* mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback(){
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    ...
                    try {
                        ...
                        SavedVideoViewer.this.startActivity(Intent.createChooser(intent, "Share video via: "));
                        return;
        ...
        delete_fab.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SavedVideoViewer.this);
