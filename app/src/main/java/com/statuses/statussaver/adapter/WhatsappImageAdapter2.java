...
import com.statuses.statussaver.recycler.ImageViewHolder;

import java.util.ArrayList;

public class WhatsappImageAdapter2 extends
        RecyclerView.Adapter<ImageViewHolder> {
    private ArrayList<MediaModel> arrayList;
    private Context context;
    private SparseBooleanArray mSelectedItemsIds;

    public WhatsappImageAdapter2(Context context,
    ...
    public MediaModel getItem(int i) {
        return (MediaModel) arrayList.get(i);
    }
    public void updateData(ArrayList<MediaModel> viewModels) {
        arrayList.clear();
